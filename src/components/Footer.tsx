        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-white">
              <p>2100 West Loop South Suite 1410</p>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <a href="https://maps.app.goo.gl/CTcKGeaSFdNFLBBL7" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-white rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors">
