        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Luật sư có kinh nghiệm của chúng tôi hiểu rõ sự phức tạp của cả các vụ kiện chấn thương cá nhân và bào chữa hình sự. Chúng tôi làm việc không mệt mỏi để bảo vệ quyền lợi của bạn và đảm bảo khoản bồi thường hoặc kết quả mà bạn xứng đáng.
              </p>
            ...
            <div className="bg-gray-50 p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-black mb-2">Hỗ Trợ Khẩn Cấp</h4>
                    <p className="text-gray-600">Hỗ trợ ngay lập tức cho các vấn đề pháp lý khẩn cấp</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="-ml-24">
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">250+ Vụ Án Làm Công Tố Viên</p>
                </div>
                <div className="text-center">
        ...
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 drop-shadow-lg">
            <Typewriter
              onInit={(typewriter) => {
                typewriter
                  .typeString("Vụ Án Của Bạn Quan Trọng Đối Với Chúng Tôi")
                  .callFunction(() => {
